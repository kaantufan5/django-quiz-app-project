...
class Category(models.Model): #Categorys -- ies
    ...
    @property
    def quiz_count(self):
        return self.quizz.count() #Bi kategorinin altındaki quizleri göstermek ve göndermek için.
...
class Quiz(UpdateCreateDate):
    ...
    def question_count(self):
        return self.question_rel.count() #Bi kategorinin altındaki quizleri göstermek ve göndermek için.
...
class Question(UpdateCreateDate):
    ...
    quiz = models.ForeignKey(Quiz, on_delete=models.CASCADE, related_name='question_rel')
